...
public class WarpPortalsCreateEvent extends Event implements Cancellable {
     ...
     * being created.
     *
     * @param s  - CommandSender that is creating the WarpPortal. Most likely a
     *           player.
     * @param po - PortalInfo for the to-be-created WarpPortal. Contains the
     ...
     * WarpPortal.
     *
     * @param newBlocks - ArrayList<Coords> of the new block coords.
     */
