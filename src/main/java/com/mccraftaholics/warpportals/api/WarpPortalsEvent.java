...
public class WarpPortalsEvent extends Event implements Cancellable {
     ...
     * by a WarpPortal
     *
     * @param p  - Player that is getting teleported
     * @param po - PortalInfo for the WarpPortal that the player has entered.
     *           Contains the WarpPortal's name, blocks, destination coords.
     * @param hp - boolean if the player has permission to be teleported or
     *           not.
     */
