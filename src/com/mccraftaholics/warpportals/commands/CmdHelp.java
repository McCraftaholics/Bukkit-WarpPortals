...
public class CmdHelp extends CommandHandlerObject {
	...
	public static final String[] CMD_DESCS = { "Equip the current item as a Portal Creation tool", "Delete a Portal by name",
			...
			"List all Portals", "List all saved Portal Destinations", "Teleport to a Portal/Destination", "Force save all Portal data",
			"Force load Portal data from portals.yml", "Backup the current Portal data to \"portals.yml_yyyy-MM-ddTkk-mm-ss.bac\"" };
